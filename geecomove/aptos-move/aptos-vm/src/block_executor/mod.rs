...
use aptos_types::{
    ...
    write_set::{WriteOp, WriteSet, WriteSetMut}, vm_status::StatusCode,
};
...
impl BlockAptosVM {
    ...
    pub fn execute_block<S: StateView>(
        ...
        //println!("PreprocessedTransaction: {} ms",start.elapsed().as_millis());
        ...
        //println!("execute_block end: {} ms",start.elapsed().as_millis());
        match ret {
            ...
            Err(Error::NONCE_TOO_NEW) => Err(VMStatus::Error(StatusCode::SEQUENCE_NUMBER_TOO_NEW)),
        }
    }
}
