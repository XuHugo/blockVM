...
use crate::{
    ...
    data_store::{
        GeecoDataStore, GENESIS_CHANGE_SET_HEAD, GENESIS_CHANGE_SET_MAINNET,
        GENESIS_CHANGE_SET_TESTNET,
    },
    common_ext::keygen::KeyGen,  
};
...
#[derive(Debug)]
pub struct GeecoExecutor {
    pub data_store: GeecoDataStore,
    block_time: u64,
    rng: KeyGen,
...
impl GeecoExecutor {
    ...
    pub fn from_genesis(write_set: &WriteSet, chain_id: ChainId) -> Self {
        let mut executor = GeecoExecutor {
            data_store: GeecoDataStore::default(),
            block_time: 0,
            //executed_output: None,
            //trace_dir: None,
            rng: KeyGen::from_seed(RNG_SEED),
            no_parallel_exec: true,
    ...
    pub fn get_state_view(&self) -> &GeecoDataStore {
        &self.data_store
    }
